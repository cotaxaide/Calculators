		...
		_EdExpenseLimits[_TY+":SAV"] = "N/A,78150,93150,117250,147250";
	...
	// StateTaxCap
        ...
        // var CTCLimits = [];
                ...
                _CTCLimits["MFS"] = 2;
                _CTCLimits["HOH"] = 3;
                _CTCLimits[_TY+":AGICap"] = "110000,75000,55000,75000";
	...
	// Alternative Minimum Tax
		//                  Exempt  Phaseout
		_AMT[_TY+":MFJ"] = "84500,  160900";
		_AMT[_TY+":SNG"] = "54300,  120700";
		_AMT[_TY+":MFS"] = "42250,   80450";
		_AMT[_TY+":HOH"] = "54300,  120700";
		_AMT[_TY+":WID"] = "54300,  120700";
	...
	// Retirement Savings Contribution (Form 8880)
		...
		_RETIRE[_TY+":MFJ"] = "37000,	40000,	62000";
		_RETIRE[_TY+":HOH"] = "27750,	30000,	46500";
		_RETIRE[_TY+":SNG"] = 
		_RETIRE[_TY+":WID"] = 
